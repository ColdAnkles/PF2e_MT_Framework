...
function add_common_macros(tokenID, isSimple = false) {
    ...
    if (!isSimple) {
        ...
        { "label": "Use Reaction", "playerEditable": 0, "command": "[h: js.ca.pf2e.generic_use_reaction(currentToken())]", "tooltip": "Use An Reaction", "sortBy": "", "group": "1. Common" },
        ...
        { "label": "Refund Reaction", "playerEditable": 0, "command": "[h: js.ca.pf2e.generic_refund_reaction(currentToken())]", "tooltip": "Regain An Reaction", "sortBy": "", "group": "1. Common" },
