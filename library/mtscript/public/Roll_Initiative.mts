...
[h: initResult = json.get(js.ca.pz2e.skill_check(token,false,checkData,bonusScopes),"checkResult")]
[h: tieBreak = js.ca.pz2e.get_actor_data_mtscript(token, "system.initiative.tiebreakPriority")]
