...
<p class='topbar'>
	Make Token: [r:macroLink("Weak","Spawn_NPC@Lib:ca.pz2e","none",json.append("[]",tokenName,"weak"))]&nbsp;[r:macroLink("Normal","Spawn_NPC@Lib:ca.pz2e","none",json.append("[]",tokenName,"normal"))]&nbsp;[r:macroLink("Elite","Spawn_NPC@Lib:ca.pz2e","none",json.append("[]",tokenName,"elite"))]&nbsp; [r:macroLink("Edit Creature","NPC_Editor@Lib:ca.pz2e","none",tokenName)]&nbsp;
</p>
};{}]
...
<p>[r, if(tokenID=="null"), code:{
	...
	[r: js.ca.pz2e.build_creature_view(tokenName, tokenID)]</p>
}]
</body>
}]